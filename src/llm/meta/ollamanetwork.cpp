...
OllamaNetWork::OllamaNetWork(const AccountProxy &account)
    : BaseNetWork(account)
{

}

QString OllamaNetWork::rootUrlPath() const
{
    return "http://localhost:11434/v1";
}

QPair<int, QByteArray> OllamaNetWork::request(const QJsonObject &data, const QString &path, QHttpMultiPart *multipart)
{
